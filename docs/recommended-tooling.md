...
| Docs & knowledge | Markdown in the repo to start; **Notion** at company stage | Docs live in git where agents read them for free. Notion earns its place when non-code collaborators and business ops appear. |
