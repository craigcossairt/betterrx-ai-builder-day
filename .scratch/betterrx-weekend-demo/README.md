# Wayfinder map: BetterRX weekend demo spec

Decision tickets for the Saturday demo. Not a build backlog. The locked spec is `docs/prd.md`.

- Start at [map.md](map.md)
